...
import { Bell, LogOut, Pencil, Check, Layers, Trash2, Gift, User } from "lucide-react";
...
import { applyTheme, getStoredTheme, setStoredTheme, type ThemeId } from "@/lib/banking/themes";
    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-20 border-b border-border/60 bg-background/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 md:px-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold leading-tight">Lunar Bank</div>
      ...
      <DioneAssistant
        ...
        callbacks={{
          ...
          onNavigate: (target) => navigate({ to: target === "offers" ? "/offers" : "/profile" }),
        }}
      />
    </div>
  );
